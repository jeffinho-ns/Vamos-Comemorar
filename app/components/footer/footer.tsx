      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>
              <br />A missão da Vamos Comemorar é facilitar o agendamento de
          ...
          <div className="">
            ...
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">Contato</a>
            </p>
          </div>
          {/* <!-- Suporte --> */}
          <div className="">
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              R. Heitor de Morais, 87 - Pacaembu São Paulo - SP
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
